...
def main():
    ...
    legend1.AddEntry(hist_K_mass_dist, "K*", "l")
    legend1.AddEntry(hist_Kbar_mass_dist, "K*bar", "l")
    legend1.Draw()
    c1.cd(2)
    ...
    legend2.AddEntry(hist_K_mass_dist_cut, "K*", "l")
    legend2.AddEntry(hist_Kbar_mass_dist_cut, "K*bar", "l")
    legend2.Draw()
    ...
    legend_p.AddEntry(hist_Kpx_dist, "K* no cut", "l")
    legend_p.AddEntry(hist_Kbarpx_dist, "K*bar no cut", "l")
    legend_p.AddEntry(hist_Kpx_dist_cut, "K* cut", "l")
    legend_p.AddEntry(hist_Kbarpx_dist_cut, "K*bar cut", "l")
    c2.cd(1)
    ...
    legend3.AddEntry(hist_Keta_dist, "K*", "l")
    legend3.AddEntry(hist_Kbareta_dist, "K*bar", "l")
    legend3.Draw()
    c3.cd(2)
    ...
    legend4.AddEntry(hist_Keta_dist_cut, "K*", "l")
    legend4.AddEntry(hist_Kbareta_dist_cut, "K*bar", "l")
    legend4.Draw()
